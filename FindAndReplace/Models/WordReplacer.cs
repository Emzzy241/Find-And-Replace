...
namespace FindAndReplace.Models
{
    ...
    {
        // This Object takes in 3 things; 1 is the sentence
        ...
        // Same thing with the Regex method below, the Equals() method could not check for partial matches
    ...
    // Date: 06-10-24: The below method works but it won't work for partial matches
    // public string FindAndReplaceWord(string newSentence, string newFindWord, string newReplaceWord)
    // {
    ...
    // The IndexOf() method is capable of checking for partial matches
    //     Replace Method:
